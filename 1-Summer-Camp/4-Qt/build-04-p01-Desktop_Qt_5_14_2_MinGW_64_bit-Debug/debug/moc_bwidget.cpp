...
struct qt_meta_stringdata_BWidget_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BWidget_t qt_meta_stringdata_BWidget = {
    {
QT_MOC_LITERAL(0, 0, 7) // "BWidget"
...
QT_INIT_METAOBJECT const QMetaObject BWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<MyWidget::staticMetaObject>(),
    qt_meta_stringdata_BWidget.data,
    qt_meta_data_BWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BWidget.stringdata0))
